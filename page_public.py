...
DF_ROUTE_TEXT = pd.read_csv('./routes.csv')
DF_ROUTE = pd.read_csv('./map.csv')
DF_CROWD = pd.read_csv('./crowd.csv')
endpt_size = 20
zoom=14
...
crowd_val = [ 90,160,140,100,120,140,200,460,310,440,500,650,580,700,520,660,790,890,830,630,510,480,410,210 ]
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
	        html.Button('搭乘大眾運輸', id='button', style={'background-color': '#DDDDDD'}),
	        html.Button('自行駕駛', id='button'),
    ...
    html.Div([
        html.Div([
            html.H3("推薦交通工具及路線 Recommdation Transportation and Routes")
        ], className='Title'),
    ...
    html.Div([
        html.Div([
            html.H3("周邊人潮密集處 Crowded Locations")
        ], className='Title'),
        html.Div([
